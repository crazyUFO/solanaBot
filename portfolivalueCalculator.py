...
class PortfolioValueCalculator:
    ...
    def fetch_price_chunk(self, chunk, retries=3):
        ...
        url = f"https://api.geckoterminal.com/api/v2/simple/networks/solana/token_price/{mint_list}"
        ...
        for attempt in range(retries):
            try:
                ...
                return {mint: float(price) for mint, price in token_prices.items() if price is not None}
    ...
    def calculate_total_value(self):
        ...
        mint_chunks = self.chunk_mints(mints, chunk_size=20)
